...
class ConceptsControllerTest < ActionController::TestCase
  ...
  test "should create concept" do
    assert_difference('Concept.count') do
      post :create, concept: { boceto2: @concept.boceto2, entrevistas: @concept.entrevistas, propuesta: @concept.propuesta, team_id: @concept.team_id }
    end
  ...
  test "should update concept" do
    patch :update, id: @concept, concept: { boceto2: @concept.boceto2, entrevistas: @concept.entrevistas, propuesta: @concept.propuesta, team_id: @concept.team_id }
    assert_redirected_to concept_path(assigns(:concept))
  end
